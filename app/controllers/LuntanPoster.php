...
class LuntanPoster extends Common
{
	...
	public function index(){
		...
		$field = input('param.field') ? input('param.field') : 'luntan';
		...
		if(!$posterset){
            ...
            Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'luntan','platform'=>'mp','content'=>$data_product_mp]);
            Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'luntan','platform'=>'wx','content'=>$data_product_wx]);
            Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'luntan','platform'=>'alipay','content'=>$data_product_mp]);
            Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'luntan','platform'=>'baidu','content'=>$data_product_mp]);
            Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'luntan','platform'=>'toutiao','content'=>$data_product_mp]);
            Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'luntan','platform'=>'qq','content'=>$data_product_mp]);
            Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'luntan','platform'=>'h5','content'=>$data_product_mp]);
            Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'luntan','platform'=>'app','content'=>$data_product_mp]);
            $posterset = Db::name('admin_set_poster')->where('aid',aid)->where('type','luntan')->where('platform',$type)->order('id')->find();
        }
